...
public class GuitarString {
    ...
    private int capacity; // Doing this so all of my methods can see it 
    ...
    /* Pluck the guitar string by replacing the buffer with white noises. */
    public void pluck() {
    ...
    public void tic() {
        ...
        double enqueued_value= DECAY * 0.5 * (dequeued_value+ buffer.peek());
